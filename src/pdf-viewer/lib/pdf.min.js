    ...
    var __webpack_modules__ = [
        ...
        (__unused_webpack_module, exports, __w_pdfjs_require__) => {
          ...
          function getDocument(t) {
            ...
            const d = t.verbosity,
              u =
                'string' !== typeof t.docBaseUrl || (0, _display_utils.isDataScheme)(t.docBaseUrl)
                  ? null
                  : t.docBaseUrl,
          ...
          function getDataProp(t) {
            ...
            if (('object' === typeof t && !isNaN(t?.length)) || (0, _util.isArrayBuffer)(t)) {
            ...
            _pumpOperatorList({
              ...
              const { map: s, transfers: n } = i,
                a = this._transport.messageHandler
                  .sendWithStream(
                    'GetOperatorList',
                    { pageIndex: this._pageIndex, intent: t, cacheKey: e, annotationStorage: s },
                    n
                  )
                  .getReader(),
          ...
          class AnnotationEditor {
            ...
            setDims(t, e) {
              ...
              this.#x?.classList.toggle(
                'small',
                t < AnnotationEditor.SMALL_EDITOR_SIZE || e < AnnotationEditor.SMALL_EDITOR_SIZE
              );
            }
            fixDims() {
            ...
            #j() {
              ...
              this._willKeepAspectRatio ||
                t.push('topMiddle', 'middleRight', 'bottomMiddle', 'middleLeft');
              for (const e of t) {
            ...
            #H(t, e) {
              ...
              if (g) {
                ...
                y = S = Math.max(
                  Math.min(Math.hypot(b[0] - f[0] - E, b[1] - f[1] - x) / t, 1 / r, 1 / o),
                  l / r,
                  h / o
                );
              } else {
                m
                  ? (y = Math.max(l, Math.min(1, Math.abs(b[0] - f[0] - E))) / r)
                  : (S = Math.max(h, Math.min(1, Math.abs(b[1] - f[1] - x))) / o);
              }
              const T = round(r * y),
                P = round(o * S);
              A = transf(...p(T, P));
            ...
            async #W() {
              ...
              e.innerText = this.#E
                ? await AnnotationEditor._l10nPromise.get('editor_alt_text_decorative_tooltip')
                : this.#S;
          ...
          class AnnotationEditorUIManager {
            ...
            get hcmFilter() {
              return (0, s.shadow)(
                this,
                'hcmFilter',
                this.#At ? this.#dt.addHCMFilter(this.#At.foreground, this.#At.background) : 'none'
              );
            }
            get direction() {
                ...
                if (a.readyState === XMLHttpRequest.DONE) {
                  if (200 === a.status || 0 === a.status) {
                    ...
                    e && a.response
                      ...
                      : !e && a.responseText && (t = (0, n.stringToBytes)(a.responseText));
                    if (t) {
                      i(t);
                      return;
                    }
          ...
          class BaseStandardFontDataFactory {
            constructor({ baseUrl: t = null }) {
              this.constructor === BaseStandardFontDataFactory &&
                (0, s.unreachable)('Cannot initialize BaseStandardFontDataFactory.');
              this.baseUrl = t;
            }
          ...
          class CanvasGraphics {
            ...
            paintChar(t, e, i, a) {
              ...
              if (l.disableFontFace || p) {
                ...
                (d !== s.TextRenderingMode.FILL && d !== s.TextRenderingMode.FILL_STROKE) ||
                  r.fill();
                (d !== s.TextRenderingMode.STROKE && d !== s.TextRenderingMode.FILL_STROKE) ||
                  r.stroke();
                r.restore();
              } else {
                (d !== s.TextRenderingMode.FILL && d !== s.TextRenderingMode.FILL_STROKE) ||
            ...
            paintImageMaskXObjectGroup(t) {
              ...
              for (const r of t) {
                ...
                d.fillStyle = s
                  ? i.getPattern(d, this, (0, n.getCurrentTransformInverse)(e), a.PathType.FILL)
                  : i;
                d.fillRect(0, 0, o, l);
                d.restore();
                e.save();
            ...
            paintImageXObjectRepeat(t, e, i, n) {
              ...
              for (let t = 0, s = n.length; t < s; t += 2) {
                l.push({ transform: [e, 0, 0, i, n[t], n[t + 1]], x: 0, y: 0, w: r, h: o });
              }
        ...
        (t, e, i) => {
          ...
          class RadialAxialShadingPattern extends BaseShadingPattern {
            ...
            getPattern(t, e, i, r) {
              ...
              if (r === a.STROKE || r === a.FILL) {
                const a = e.current.getClippedPathBoundingBox(r, (0, n.getCurrentTransform)(t)) || [
                    0, 0, 0, 0,
                  ],
          ...
          class MeshShadingPattern extends BaseShadingPattern {
            ...
            getPattern(t, e, i, r) {
              ...
              let o;
              if (r === a.SHADING) {
                o = s.Util.singularValueDecompose2dScale((0, n.getCurrentTransform)(t));
              } else {
        ...
        (t, e, i) => {
          ...
          function wrapReason(t) {
            t instanceof Error ||
              ...
              (0, s.unreachable)('wrapReason: Expected "reason" to be a (possibly cloned) Error.');
            switch (t.name) {
              case 'AbortException':
              ...
              const e = t.streamId,
                ...
                d = {
                  enqueue(t, r = 1, o) {
                    ...
                    a.postMessage(
                      { sourceName: i, targetName: n, stream: h, streamId: e, chunk: t },
                      o
                    );
                  },
                  close() {
          ...
          e.SVGGraphics = class SVGGraphics {
            ...
            paintImageXObject(t) {
              ...
              e
                ...
                : (0, n.warn)(`Dependent image with object ID ${t} is not ready yet`);
            }
            ...
            serialize(t = !1) {
              ...
              const e = FreeTextEditor._internalPadding * this.parentScale,
                ...
                n = a.AnnotationEditor._colorManager.convert(
                  this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#je
                ),
                r = {
                  annotationType: s.AnnotationEditorType.FREETEXT,
                  color: n,
                  ...
                  for (const t of r) {
                    ...
                    i &&
                      (c.has(i)
                        ...
                        : (0, s.warn)(`_bindResetFormAction - element not allowed: ${e}`));
                  }
                  this.enableScripting &&
                    this.linkService.eventBus?.dispatch('dispatcheventinsandbox', {
                      source: this,
          ...
          class PopupElement {
            ...
            #si(t) {
              t.altKey ||
                ...
                t.ctrlKey ||
                t.metaKey ||
                (('Enter' === t.key || ('Escape' === t.key && this.#gi)) && this.#hi());
            }
            #hi() {
              this.#gi = !this.#gi;
              if (this.#gi) {
          ...
          const s = {
            ...
            get: async (t, e = null, i = getL10nFallback(t, e)) =>
              (function formatL10nValue(t, e) {
                return e
                  ? t.replaceAll(/\{\{\s*(\w+)\s*\}\}/g, (t, i) => (i in e ? e[i] : `{{${i}}}`))
                  : t;
              })(i, e),
            async translate(t) {},
          };
        ...
        (t, e, i) => {
          ...
          e.XfaLayer = class XfaLayer {
            ...
            static render(t) {
              ...
              n.attributes &&
                this.setAttributes({ html: r, element: n, intent: a, linkService: i });
              const o = [[n, -1, r]],
                l = t.div;
              l.append(r);
              if (t.viewport) {
        ...
        (t, e, i) => {
          ...
          class InkEditor extends n.AnnotationEditor {
            ...
            isEmpty() {
              return (
                0 === this.paths.length || (1 === this.paths.length && 0 === this.paths[0].length)
              );
            }
            #Qi() {
              const {
