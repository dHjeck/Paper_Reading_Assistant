...
- 画像領域の選択とマルチモーダル画像説明、および画像説明結果に対する追加質問。
...
> **テスト状況：画像説明機能と追加質問機能に対応しています。** 現在、画像認識のエンドツーエンドテストは Kimi 系のビジョンモデルでのみ完了しています。その他のビジョンモデルはテストされておらず、問題が存在する可能性があります。問題があれば Issue で報告してください。
...
画像説明と追加質問は Kimi 系モデルで手動テスト済みです。その他のビジョンモデル系列はまだ検証されていません。
